...
const NavBar = () => {
    ...
    return (
        ...
        expanded={dropDown}
        collapseOnSelect expand='md' bg='primary' variant='primary' className="py-2 fixed-top text-white" style={{ borderBottom: "#008ed6 3px solid" }}>
            <AppBar.Brand href='/' style={{ fontSize: "4vh" ,color: "blue",fontWeight: "bold"}}>Money Mentor</AppBar.Brand>
